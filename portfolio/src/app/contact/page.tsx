    ...
    <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10 lg:py-24">
      <Reveal>
        ...
        <h1 className="font-display mt-4 text-5xl tracking-tight sm:text-6xl">
          Let&apos;s build your <span className="text-gradient-accent">next product.</span>
        </h1>
      ...
      <div className="mt-16 grid gap-6 lg:grid-cols-2">
        <Reveal delay={0.1}>
          <a
            ...
            className="glass-card card-shine group block h-full rounded-3xl p-10 transition-all hover:-translate-y-1"
          >
            <SectionLabel>Email — fastest response</SectionLabel>
            <p className="font-display mt-4 text-2xl tracking-tight transition-colors group-hover:text-primary sm:text-3xl">
              {site.email}
            </p>
